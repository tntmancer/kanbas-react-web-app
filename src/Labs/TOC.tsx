...
//         <li><a id="wd-github" href="https://github.com/tntmancer/kanbas-react-web-app">Github for A1</a></li>
//       </ul>
//     );
//   }  
...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills">
      ...
      <li className="nav-item">
        <a id="wd-k" href="https://github.com/tntmancer/kanbas-react-web-app" className="nav-link">
          My GitHub
        </a>
      </li>
    </ul>
